...
-- POPULING user
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), '6120ce60-4499-4a8d-816b-9080e3f8e6e2', '00038057', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'user.gadelha@marinha.mil.br', true, 'LUCIYJQ22QW4VGSP') ON CONFLICT DO NOTHING;
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), '67d43c5e-bd63-4e17-b386-09438e758194', '00038058', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'moderator.gadelha@marinha.mil.br', true, 'WZBEBCKNFNVAYMNQ') ON CONFLICT DO NOTHING;
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), '02560770-e8b9-4c3b-b220-a2ce7be2cbda', '00038059', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'admin.gadelha@marinha.mil.br', true, 'Y7L6TIJGRU5U44F4') ON CONFLICT DO NOTHING;
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), 'ba7f72cf-9cdb-4874-9632-6fa3a243c513', '00038060', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'reviewer.gadelha@marinha.mil.br', true, 'UYA2ZVJ7UOULVPMY') ON CONFLICT DO NOTHING;
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), '40063b4d-3b06-459e-a58d-637725c02927', '00038061', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'verifier.gadelha@marinha.mil.br', true, 'IUIAJZSQEKHM5ADM') ON CONFLICT DO NOTHING;
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), '7b88d564-b34b-4f07-9775-a67bd1777dec', '00038062', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'operator.gadelha@marinha.mil.br', true, '5IK2OXZMAHOFKLNM') ON CONFLICT DO NOTHING;
INSERT INTO mfa.user(created_at, updated_at, id, username, password, email, active, secret) VALUES (NOW(), NOW(), '482d27e6-b9a6-4a71-ac3a-8671e481e9b4', '00038063', '$2a$10$I2w4HMg8QY01/fY3JWFy.On89HmqtJajcyv4PhIt322K5RjhmMEcS', 'viewer.gadelha@marinha.mil.br', true, 'ULPM6JOBI6DU2AGL') ON CONFLICT DO NOTHING;
